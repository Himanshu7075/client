        ...
        <div key={index} className='flex flex-col md:flex-row justify-between bg-primary/8 border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
          ...
          <div className='flex flex-col md:items-end md:text-right justify-between'>
            <div className='flex items-center gap-4'>
              ...
              {!item.isPaid && <button className='bg-primary hover:bg-primary-dull active:scale-95 px-4 py-1.5 mb-3 text-sm rounded-full font-medium cursor-pointer'>Pay Now</button>}
            </div>
