...
const MovieDetails = () => {
  ...
  return show ?  (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='overflow-auto no-scrollbar mt-8 pb-4'>
      ...
      <div className='flex justify-center mt-20'>
        ...
        className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer active:scale-95'>Show More</button>
      </div>
