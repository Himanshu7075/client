    ...
    <>
        ...
        <div className='mt-6'>
            ...
            <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
                ...
                <button onClick={handleDateTimeAdd} className='bg-primary/80 text-white px-3 py-2 text-sm rounded-lg hover:bg-primary cursor-pointer active:scale-95'>
                Add Time</button>
            </div>
        </div>
        ...
        <button className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer active:scale-95'>Add Show</button>
    </>
  ) : <Loading />
}
