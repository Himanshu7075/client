...
const Dashbord = () => {
    ...
    const dashbordCards = [
        { title: 'Total Bookings', value: dashbordData.totalBokkings || '0', icon: ChartLineIcon },
        { title: 'Total Revenue', value: currency + dashbordData.totalRevenue || '0', icon: CircleDollarSignIcon },
        { title: 'Actice Shows', value: dashbordData.activeShows.length || '0', icon: PlayCircleIcon },
        { title: 'Total Users', value: dashbordData.totalUser || '0', icon: UserIcon },
    ]
  ...
  return !loading ? (
    ...
    <p className='mt-10 text-lg font-medium'>Active Title</p>
        ...
        {dashbordData.activeShows.map((show) => (
            <div key={show.id} className='w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300'>
                ...
                <div className='flex items-center justify-between px-2'>
                    <p className='text-;g font-medium'>{currency} {show.showPrice}</p>
